...
// ---- guided stroke paths for the 12 vowels (approximate motion guides) ----
// Each entry is an ordered array of SVG path `d` strings in the 0 0 200 200 space.
// The faint glyph behind shows the true shape; these convey stroke order + direction.
const TRACE = {
  "அ": ["M64 58 C36 64 36 150 78 150 C108 150 108 96 80 92", "M126 46 C150 70 150 150 126 162"],
  "ஆ": ["M64 58 C36 64 36 150 78 150 C108 150 108 96 80 92", "M126 46 C150 70 150 150 126 162", "M150 56 C172 56 176 84 150 92"],
  "இ": ["M70 54 C44 54 44 96 72 96 C96 96 96 132 70 142 C50 150 44 128 60 120", "M120 50 C150 60 150 150 120 160"],
  "ஈ": ["M70 54 C44 54 44 96 72 96 C96 96 96 132 70 142 C50 150 44 128 60 120", "M118 48 C150 58 150 150 118 160", "M150 50 C168 56 168 78 150 84"],
  "உ": ["M60 70 C60 44 110 44 110 78 C110 120 64 120 64 150 C64 168 96 168 110 150"],
  "ஊ": ["M58 70 C58 44 108 44 108 78 C108 120 62 120 62 150 C62 168 94 168 108 150", "M138 70 C160 70 160 150 138 158", "M150 64 C170 70 170 96 150 102"],
  "எ": ["M120 56 C150 56 150 150 116 150 C84 150 60 120 60 96 C60 70 92 60 104 84"],
  "ஏ": ["M120 56 C150 56 150 150 116 150 C84 150 60 120 60 96 C60 70 92 60 104 84", "M70 40 L150 40"],
  "ஐ": ["M58 60 C44 84 64 110 86 96 C70 130 96 156 116 138", "M132 50 C156 70 156 150 132 162"],
  "ஒ": ["M70 64 C42 64 42 150 84 150 C116 150 116 92 86 86", "M120 60 C150 70 150 150 120 160"],
  "ஓ": ["M70 64 C42 64 42 150 84 150 C116 150 116 92 86 86", "M120 60 C150 70 150 150 120 160", "M150 56 L172 56 L172 30"],
  "ஔ": ["M64 64 C40 64 40 150 80 150 C110 150 110 92 84 86", "M124 56 C152 66 152 150 124 160", "M150 56 C172 56 176 86 150 94"],
};
